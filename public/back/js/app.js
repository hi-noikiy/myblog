...
var loginRouter = {
  ...
  component: function component(resolve) {
    return __webpack_require__.e/* require */(1).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(70)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  }
};
...
exports.default = [loginRouter].concat(appRouters);
...
var update = __webpack_require__(6)("6f62460f", content, false, {});
...
var _http = __webpack_require__(55);
...
exports.default = {
  login: function login(data) {
    return _http2.default.post('/api/auth/login', data);
  },
  getProfile: function getProfile() {
    return _http2.default.get('/api/profile');
  },
  logout: function logout() {
    return _http2.default.post('/api/auth/logout');
  }
};
...
_axios2.default.interceptors.request.use(function (config) {
  ...
  switch (error.response.status) {
    ...
    case 401:
      return undefined.$store.dispatch('logout');
      break;
    // 如果响应中的 http code 为 400，那么就弹出一条错误提示给用户
    case 400:
      return undefined.$Message.error(error.response.data.error);
      break;
  }
});
// 自定义的 axios 响应拦截器
_axios2.default.interceptors.response.use(function (response) {
  ...
  if (token) {
    ...
    _store2.default.dispatch('refreshToken', token);
  }
  return response;
}, function (error) {
  switch (error.response.status) {
    // 如果响应中的 http code 为 401，那么则此用户可能 token 失效了之类的，我会触发 logout 方法，清除本地的数据并将用户重定向至登录页面
    case 401:
      return _store2.default.dispatch('logout');
      break;
    // 如果响应中的 http code 为 400，那么就弹出一条错误提示给用户
    case 400:
      return undefined.$Message.error(error.response.data.error);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("d927f4bc", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
